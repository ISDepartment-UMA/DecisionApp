...
- (void)addCharacteristic:(UIButton *)sender
{
    ...
    alert.superCharacteristic = [self.SuperCharacteristics objectAtIndex:[self.tableView indexPathForCell:cell].section-1];
    [alert show];
}
...
- (void)alertView:(AlertView *)alertView clickedButtonAtIndex:(NSInteger)buttonIndex{ 
    ...
    //if insertbutton clicked and title is characteristic and input not empty
        ...
        [AvailableCharacteristic addNewAvailableCharacteristic:[[alertView textFieldAtIndex:0] text] toSuperCharacteristic:alertView.superCharacteristic toManagedObjectContext:self.managedObjectContext];
