...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section
{
    ...
    return [[usedCharacteristics objectAtIndex:section] count];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    //info cell
        ...
        [cell.detailTextLabel setFont:[UIFont fontWithName:@"BitstreamVeraSans-Bold" size:cell.detailTextLabel.font.pointSize]];
