...
- (void)deviceOrientationDidChange:(NSNotification *)notification {
    ...
    if (UIInterfaceOrientationIsPortrait(deviceOrientation)) {
        ...
        CGFloat heightOfLabel = (heightOfView - 100) / 3;
        CGFloat widthOfLabel = heightOfLabel;
        
        CGFloat yOriginFirstLabel = 30;
        CGFloat yOriginSecondLabel = 50 + heightOfLabel;
        CGFloat yOriginThirdLabel = 70 + (2 * heightOfLabel);
        ...
        //move labels
        [self.subviewLabelCore setFrame:CGRectMake(20, 30, 314, 267)];
        [self.subviewLabelOutsourcing setFrame:CGRectMake(354, 30, 314, 267)];
        [self.subviewLabelIndifferent setFrame:CGRectMake(688, 30, 314, 267)];
        
        //move table views
        [self.tableViewCore setFrame:CGRectMake(20, 308, 314, 360)];
        [self.tableViewOutsourcing setFrame:CGRectMake(354, 308, 314, 360)];
        [self.tableViewIndifferent setFrame:CGRectMake(688, 308, 314, 360)];
